...
function listBox(){
  for (var i = 0; i < 2; i++) {
    if (i == 0){
      let activeCar = document.createElement("div");
      activeCar.classList.add("carousel-item");
      activeCar.classList.add("active");
      listbox.appendChild(activeCar);

      let con = document.createElement("div");
      con.classList.add("container");
      con.classList.add("d-flex");
      con.classList.add("row");
      activeCar.appendChild(con);
      ...
      for (var j = 0; j < 4; j++) {
        ...
        img.setAttribute("data-src","holder.js/900x400?theme=industrial");
        card.appendChild(img);

        let body = document.createElement("div");
        body.classList.add("card-body");
        let txt = document.creatTextNode(`${arr[j].price}`);
